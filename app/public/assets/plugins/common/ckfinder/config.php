<?php
// require_once 'C:\xampp\htdocs\190booking.backend\public\define.php';
...
$config['licenseName'] = URL_APP;
$config['licenseKey']  = '9HYHPL1KCXBT3D1VFT5AK339DRXGC';
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => URL_CKFINDER,
//    'root'         => PATH_UPLOAD, // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
