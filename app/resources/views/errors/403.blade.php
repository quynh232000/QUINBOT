	...
	<div class="error">
		<div class="container-floud">
			<div class="col-xs-12 ground-color text-center">
				...
				<h2 class="h1">Bạn không có quyền truy cập trang này! Vui lòng liên hệ bộ phận <a href="https://hotro.190booking.com/" target="_blank" style="color: #E60000">Hỗ trợ</a></h2>
			</div>
		</div>
	</div>
<!-- Error Page -->
